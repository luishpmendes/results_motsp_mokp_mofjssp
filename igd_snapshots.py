...
cumulative_distribution_df.to_csv('igd_snapshots_easy.csv')
...
plt.tight_layout()
# Save the plot
plt.savefig('igd_snapshots_easy.png')
plt.close()
...
cumulative_distribution_df.to_csv('igd_snapshots_hard.csv')
...
plt.tight_layout()
# Save the plot
plt.savefig('igd_snapshots_hard.png')
plt.close()
